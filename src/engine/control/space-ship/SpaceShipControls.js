...
export default class SpaceShipControls extends AbstractControls {
    ...
    rotationSpeed = 0;
      ...
      * @param {CameraManager} spaceShipCameraManager
      */
    constructor(mouseInterface, keyboardInterface, spaceShipCameraManager) {
        super();

        this.mouse = mouseInterface;
        this.keyboard = keyboardInterface;
        this.cameraManager = spaceShipCameraManager;
